                        ...
                        <div className="xl:w-1/4 md:w-1/2  mt-9 p-4 ">
                            <a href={newsUrl} target="_blank" rel="noreferrer">
                                <div className={`w-[310px] ${this.props.mode === 'white' ? 'bg-gray-200' : 'bg-gray-800'} hover:shadow-lg ${this.props.mode === 'white' ? ' hover:shadow-gray-500' : ' hover:shadow-indigo-500'} bg-opacity-40 p-6 rounded-lg`}>
                                    ...
                                    <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">SOURCE- <span className={`${this.props.mode === 'white' ? 'text-black' : 'text-white'}`}>{source}</span>  </h3>
                                    <h2 className={`mt-2 text-lg ${this.props.mode === 'white' ? 'text-black' : 'text-white'} font-medium title-font mb-4`}>{title}</h2>
