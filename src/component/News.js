        ...
        return (
            <>
                ...
                <div className="containe px-10 m-4 justify-between flex">
                    <button disabled={this.state.page <= 1} onClick={this.handelPrevButton} className="disabled:cursor-not-allowed  bg-transparent hover:bg-cyan-500 text-cyan-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                        &larr; {this.state.page === 1 ? " " : this.state.page - 1} Previous
                    </button>

                    <div className='mt-3  font-semibold text-lg'>Page {this.state.page}</div>

                    <button disabled={this.state.page + 1 > Math.ceil(this.state.totalResult / this.props.pageSize)} onClick={this.handelNextButton} className="disabled:cursor-not-allowed bg-transparent hover:bg-cyan-500 text-cyan-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
